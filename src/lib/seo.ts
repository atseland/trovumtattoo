...
export const businessPhoneHref = 'sms:97090414'
...
export const publicRoutes = [
  {
    ...
    description:
      'Trovum Tattoo lager custom dark art, blackwork, black and grey og semi realistic tatoveringer hos Tigr Tattoo i Sandvika. Enkel bookingprosess.',
    priority: 1,
  },
  {
    path: '/book',
...
export function createLocalBusinessJsonLd() {
  return {
    ...
    priceRange: '$$',
    description:
      'Trovum Tattoo lager custom tatoveringer innen dark art, blackwork, black and grey og semi realism hos Tigr Tattoo i Sandvika. Enkel bookingprosess.',
  }
}
