/**
 * Layout 8: Portfolio Before About
 *
 * Layout 4 (Typographic Minimal) med én endring:
 * portefølje-seksjonen og om-seksjonen er byttet om.
 *
 * Rekkefølge:
 *   Hero → Portefølje (horisontal scroll) → Om → Booking → Footer
 */
...
export default function Layout8PortfolioBeforeAbout() {
  return (
    <div className="min-h-screen bg-bg text-paper">

      {/* ============================================================ */}
      {/*  HERO — identisk med L4                                      */}
      {/* ============================================================ */}
