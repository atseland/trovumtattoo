/**
 * Layout 4: Typographic Minimal
 *
 * Konsept: Typografidrevet layout der helten er ren tekst — ingen bilder.
 * Stor, ekspressiv serif-typografi etablerer stemning. Porteføljen
 * presenteres som en horisontal scroll-stripe midtveis. Hele siden
 * føles som en galleriinvitasjon: elegant, stillferdig, selvsikker.
 *
 * Kjennetegn:
 * - Ren tekst-hero med dramatisk typografi og subtil dekorasjon
 * - Om-seksjon som enkel, sentrert prosa
 * - Horisontal porteføljescroll med captions under
 * - Minimal vertikal plass — alt er stramt
 * - Dekorativ ornamentlinje som seksjonsdeler
 *
 * Effektiv for tatovør fordi: Skiller seg fra bildetunge konkurrenter.
 * Typografien signaliserer smak og trygghet. Når besøkeren når
 * porteføljen, er de allerede engasjert.
 */
...
export default function Layout4TypographicMinimal() {
  return (
    <div className="min-h-screen bg-bg text-paper">
      ...
      <section className="flex min-h-[85vh] flex-col items-center justify-center px-6 py-20 text-center md:min-h-screen md:px-12">
        ...
        {/* Ornament */}
        <Ornament className="mb-6 md:mb-10" />
      ...
      <section className="border-t border-rule px-6 py-14 md:px-12 md:py-24">
        <div className="mx-auto max-w-xl text-center">
          ...
          {/* Stilretninger som subtil tekst */}
      ...
      {/* ============================================================ */}
      {/*  PORTEFØLJE — Horisontal scroll-stripe                       */}
      {/* ============================================================ */}
      ...
      {/* ============================================================ */}
      {/*  BOOKING / KONTAKT — Minimalt og sentrert                    */}
      {/* ============================================================ */}
      <section className="border-t border-rule px-6 py-14 md:px-12 md:py-24">
        <div className="mx-auto max-w-xl text-center">
